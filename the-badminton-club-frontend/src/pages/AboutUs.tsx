    ...
    <section className="w-full">
        ...
        <div className={containerHero}>
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-lg text-muted mt-4 max-w-3xl">
              Building Edinburgh's most vibrant badminton community, one rally
              at a time
            </p>
          </div>
        </div>
      ...
      <section className="bg-white py-16 sm:py-20 lg:py-24">
        <div
          className={
            containerContent +
            " flex flex-col lg:flex-row items-center gap-12 lg:gap-14"
          }
        >
          {/* VIDEO */}
          ...
          <div className="w-full lg:w-1/2 text-left">
            ...
            <div className="pt-6 flex flex-col gap-5">
              ...
              <p className="body text-muted leading-relaxed">
                Today, we're proud to be Edinburgh's premier badminton facility,
                offering world-class courts, expert coaching, and a vibrant
                community.
              </p>

              <p className="body text-muted leading-relaxed">
                Our commitment goes beyond courts — we nurture talent, build
                friendships, and create opportunities for growth.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 sm:py-24 lg:py-32 bg-white">
        <div className={containerNarrow}>
          <h2 className="h2 text-center mb-12 sm:mb-16">Our Journey</h2>
