    ...
    <section className="w-full bg-background">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="flex flex-col gap-6">
              ...
              <p className="text-lg text-base text-muted leading-relaxed max-w-prose">
                ...
                games to competitive training, we help you improve properly.
              </p>
      ...
      <section className="bg-surface py-16 sm:py-20 lg:py-24 ">
        <div className="max-w-7xl mx-auto px-5 sm:px-6">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-10">
            {[
              {
                icon: "/images/icons/person-icon.svg",
                value: 500,
      ...
      <section className="bg-surface py-16 sm:py-24 lg:py-32 ">
        <div className="max-w-7xl mx-auto px-5 sm:px-6">
          ...
          <p className="text-body text-muted mt-3">Updates from the club</p>
