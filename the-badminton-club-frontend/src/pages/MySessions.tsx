  ...
  return (
    <div className="bg-background">
      ...
      <div className="max-w-5xl mx-auto px-5 sm:px-6 py-16 md:py-24">
        {/* HEADER */}
        <div className="mb-8">
          <h1 className="h2 text-2xl md:text-4xl">My Sessions</h1>

          <p className="text-muted mt-2">Manage your upcoming bookings</p>
        </div>
        ...
        {/* EMPTY STATE */}
        {sessions.length === 0 && (
          <p className="text-muted">You have no upcoming sessions.</p>
        )}
