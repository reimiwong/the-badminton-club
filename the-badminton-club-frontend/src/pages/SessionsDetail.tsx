          ...
          <div className="p-5 md:p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-sm">
              <div className="flex items-start gap-3">
                <img
                  className="w-5 h-5"
                  src="/images/icons/green-calendar-icon.svg"
                />
                <div>
              ...
              <div className="flex items-start gap-3">
                <img
                  className="w-5 h-5"
                  src="/images/icons/green-location-icon.svg"
                />
                <div>
              ...
              <div className="flex items-start gap-3">
                <img
                  className="w-5 h-5"
                  src="/images/icons/green-players-icon.svg"
                />
                <div>
                  <p className="text-muted">Availability</p>
                  <p className="font-semibold">
                    {session.capacity - session.bookings.length} of{" "}
              ...
              <div className="flex items-start gap-3">
                <img
                  className="w-5 h-5"
                  src="/images/icons/green-skill-icon.svg"
                />
                <div>
