  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* FORM */}
        <form className="w-full rounded-3xl bg-surface border border-border p-6 sm:p-8 flex flex-col gap-5 shadow-[0_20px_60px_rgba(0,0,0,0.08)] hover:shadow-[0_28px_80px_rgba(0,0,0,0.12)] transition-shadow duration-300">
          {/* EMAIL */}
