...
const navLinkClass =
  "relative text-muted transition-all duration-200 ease-out hover:text-primary hover:-translate-y-0.5 after:content-[''] after:absolute after:left-0 after:-bottom-1 after:h-[2px] after:w-0 after:bg-primary after:transition-all after:duration-200 hover:after:w-full";

const burgerNavLinkClass =
  "text-muted transition-all duration-200 ease-out hover:text-primary hover:translate-x-1 hover:font-medium";
